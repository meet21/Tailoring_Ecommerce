...
<!------------ single product details ------->
    ...
    <div class="small-container single-product">
        <div class="row">
    <div class="col-2">
        <img src="images/ladies%20special.jpeg" height="400px" id="product-img">
            ...
            <div class="col-2">
                <p>Home / Lehenga</p>
                <h5>TWINNING SPECIAL FOR SANGEET</h5>
                ...
                <input type="number" value="1">
                 <btn><a class="btn cart_p" >Add To Cart</a></btn>
                <h3>Product Details</h3>
                <p>Exclusively hand made lehenga's available in different colours and styles.<br>BUY on This Diwali with more offers.</p>
            </div>
        </div>
    </div>
